...
const modelPath = '/assets/models/test/'; // path to model folder that will be loaded using http
...
export const drawFaces = (canvas, data, fps) => {
  // console.log(canvas)
  // console.log(data)
...
async function setupCamera(_video, _canvas) {
...
export const main = async (video, canvas) => {
  var _a, _b;
  // initialize tfjs
  ...
  // check version
  log(`Version: FaceAPI ${str((faceapi === null || faceapi === void 0 ? void 0 : faceapi.version) || '(not loaded)')} TensorFlow/JS ${str(((_a = faceapi === null || faceapi === void 0 ? void 0 : faceapi.tf) === null || _a === void 0 ? void 0 : _a.version_core) || '(not loaded)')} Backend: ${str(((_b = faceapi === null || faceapi === void 0 ? void 0 : faceapi.tf) === null || _b === void 0 ? void 0 : _b.getBackend()) || '(not loaded)')}`);
